...
| C | Video processing pipeline | In progress — CP-C.P1–P5 Implemented; P6–P8 and C1 TBD |
...
**Progress note**: Slice A complete 2026-07-21 (including landing refinement: toolbar-free home, problem/solution, signed-in → `/cameras`). Slice B complete 2026-07-21 — apply Alembic revision `20260721_000002` for `deleted_at` + unique active name. Slice C started 2026-08-24 — **CP-C.P1–P5** (simulate feed, receive stream, 1-minute chunks, camera+time filenames, pre-stage integrity check); see `docs/CLIENT_PROGRAMMER_USER_STORIES.md`.
